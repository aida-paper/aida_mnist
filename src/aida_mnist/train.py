...
from aida_mnist.datamodule import CustomMNISTDataModule
from aida_mnist.sag import sag
from aida_mnist.utils import sample, evaluate, update_positives_negatives, calculate_sens_spec
            ...
            logger.log(
                {
                    ...
                    "uncertainty": np.mean(u[-batch_size:]),
                    "threshold": g[-1],
